...
export class VectorComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    $(function () {
      ...
      (<any>jQuery('#worldMap2')).vectorMap({
        map: 'world_en',
      ...
      (<any>jQuery('#vmap_russia')).vectorMap({
        map: 'russia_en',
        backgroundColor: '#353c48',
        color: '#A890D3',
        hoverOpacity: 0.7,
      ...
      (<any>jQuery('#vmap_europe')).vectorMap({
        map: 'europe_en',
        backgroundColor: '#353c48',
        color: '#A890D3',
        hoverOpacity: 0.7,
      ...
      (<any>jQuery('#vmap_germany')).vectorMap({
        map: 'germany_en',
        backgroundColor: '#353c48',
        color: '#A890D3',
        hoverOpacity: 0.7,

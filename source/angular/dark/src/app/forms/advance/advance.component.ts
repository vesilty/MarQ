...
export class AdvanceComponent implements OnInit {
  ...
  function initBasicSelect(){
	...
	$('select').formSelect();
	$('#sel').formSelect();
	var data=[{id:1,name:"Option 1"},{id:2,name:"Option 3"},{id:3,name:"Option 2"}];
...
function initGroupSelect(){
	...
	$('#sel-grp').formSelect();
	var data_sel_grp=[{id:1,name:"Option 1"},{id:2,name:"Option 3"},{id:3,name:"Option 2"}];
	var data_sel_grp1=[{id:4,name:"Option 11"},{id:5,name:"Option 31"},{id:6,name:"Option 21"}];
...
function initImageSelect(){
	/* select with image */
	$('#imgsel').formSelect();
	var data=[{id:1,name:"Option 1", url:"../../assets/images/user/user1.jpg"},{id:2,name:"Option 3",url:"../../assets/images/user/user2.jpg"},{id:3,name:"Option 2",url:"../../assets/images/user/user3.jpg"}];
